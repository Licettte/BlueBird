...
VALUES ('basic', 1, 'web', 'Company A'),
       ('important', 1, 'web', 'Company B'),
       ('basic', 2, 'mobile', 'Company C'),
       ('important', 2, 'mobile', 'Company D'),
       ('basic', 3, 'web', 'Company E'),
       ('important', 3, 'mobile', 'Company F'),
       ('basic', 4, 'mobile', 'Company G'),
       ('important', 4, 'web', 'Company H'),
       ('basic', 5, 'mobile', 'Company I'),
       ('important', 5, 'web', 'Company J'),
       ('basic', 6, 'web', 'Company K'),
       ('important', 6, 'mobile', 'Company L'),
       ('basic', 7, 'mobile', 'Company M'),
       ('important', 7, 'web', 'Company N'),
       ('basic', 8, 'web', 'Company O'),
       ('important', 8, 'mobile', 'Company P'),
       ('basic', 9, 'mobile', 'Company Q'),
       ('important', 9, 'web', 'Company R'),
       ('basic', 10, 'web', 'Company S'),
